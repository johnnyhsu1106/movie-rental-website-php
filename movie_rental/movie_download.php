...
<?php
	...
	if (isset ($_SESSION['username']) || (!empty($_COOKIE['username']) && isset($_COOKIE['username']) )){
		...
		if (isset($_SESSION['moviesToDownload']) and !empty($_SESSION['moviesToDownload'])){
			echo "<li><a href=''><span class='glyphicon glyphicon-shopping-cart'></span><span class='badge'>"; 
...
?>
	...
	<main>
		...
		<section>
			<div class = "container-fluid">	
					<div class = "row">
						<h1 class = "center-block text-center col-xs-12 col-md-12 col-lg-12">Enjoy Your movie</h1>
					</div>
					...
					<div class="row">
						<div class="btn btn-primary btn-lg text-center col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-4 col-md-4 col-md-offset-4 col-lg-2 col-lg-offset-5">
							<a href="" class="text-white text-hover-white">Click to download</a>
						</div>
					</div>
			</div>
		</section>
