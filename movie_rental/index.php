	...
	if (isset ($_SESSION['username']) || (!empty($_COOKIE['username']) && isset($_COOKIE['username']) )){
		...
		echo '
					<ul class="nav navbar-nav navbar-right">
						<li ><a href="#home" class="text-center"><span class="glyphicon glyphicon-home"></span> Home<span class="sr-only">(current)</span></a></li>
...
?>
	...
	<main>
				...
				<div class="row">
						<form  action="./search_result.php" method="post">
							<div class="form-group  col-xs-10 col-sm-6 col-xs-offset-1 col-sm-offset-3">
								<label for="search_keyword" class="hidden"></label>
								<div class="input-group "> 

									<input type="text" class="form-control" name="searchKeyword" id="search_keyword" placeholder="Search the movie" >
		...
		<section>
			<div class="container-fluid">
				<h2>New Releases</h2>
				<a href=""><h4 class="text-right">See More &gt;</h4></a>
				<div class="row">
					<div class="col-xs-12 col-sm-6 movie-poster">
						<a href="">
							<img src="image/nine-lives.jpg" alt="nine lives " class="img-responsive">
						</a>
					</div>
					...
					<div class="col-xs-6 col-sm-3 ">
						<a href="" >
							<img src="image/the-wild-life.jpg" alt="the wild life" class="img-responsive">
						</a>
					</div>
					<div class="col-xs-6 col-sm-3">
						<a href="" >
							<img src="image/anthropoid.jpg"  alt="anthropoid" class="img-responsive">
						</a>
					</div>
					<div class="col-xs-6 col-sm-3 ">
						<a href="">
							<img src="image/the-intervention.jpg" alt="the intervention" class="img-responsive">
						</a>
					</div>
					
					<div class="col-xs-6 col-sm-3">
						<a href="">
							<img src="image/batman-return-of-the-caped-crusaders.jpg" alt="batmam return of the caped crusaders" class="img-responsive">
						</a>
					</div>
				</div>
			</div>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-6 ">
						<a href="">
							<img src="image/bad-moms.jpg" alt="bad moms" class="img-responsive">
						</a>
					</div>
					<div class="col-xs-6 col-sm-3">
						<a href="">
							<img src="image/mechanic-resurrection.jpg" alt="mechanic resurrection" class="img-responsive">
						</a>
					</div>
					<div class="col-xs-6 col-sm-3">
						<a href="" >
							<img src="image/hell-or-high-water.jpg" alt="hell or high water" class="img-responsive">
						</a>
					</div>
					<div class="col-xs-6 col-sm-3 ">
						<a href="">
							<img src="image/independence-day-resurgence.jpg" alt="independence day resurgence" class="img-responsive">
						</a>
					</div>
					<div class="col-xs-6 col-sm-3 ">
						<a href="" >
							<img src="image/finding-dory.jpg" alt="finding dory"  class="img-responsive">
						</a>
					</div>
		...
		<section>
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-6">
						<a href="">
							<img src="image/petes-dragon-2016.jpg" alt="petes dragon 2016" class="img-responsive">
						</a>
					</div>
					<div class="col-xs-6 col-sm-3">
						<a href="" >
							<img src="image/the-bfg.jpg" alt="the bfg"  class="img-responsive">
						</a>
					</div>
					<div class="col-xs-6 col-sm-3">
						<a href="">
							<img src="image/dont-breathe.jpg" alt="dont breathe" class="img-responsive">
						</a>
					</div>
					<div class="col-xs-6 col-sm-3">
						<a href="" >
							<img src="image/ben-hur-1.jpg" alt="ben hur" class="img-responsive">
						</a>
					</div>
					<div class="col-xs-6 col-sm-3">
						<a href="">
							<img src="image/war-dogs.jpg" alt="war dogs" class="img-responsive">
						</a>
					</div>
				</div>
			</div>
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-xs-12 col-md-6 map">
						<h3 class="tittle">We Located</h3>
						<div class="">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4013.5518960178038!2d-110.95222703696706!3d32.23166724818828!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x86d671aaee5d9a4d%3A0x8c5868c06440cf66!2sThe+University+of+Arizona!5e0!3m2!1sen!2sus!4v1480623927896" width="100%" height="280" frameborder="0" style="border:0" allowfullscreen></iframe>
						</div>
					</div>
					<!--=============================== Map End =============================== -->
						...
						<h3 class="tittle">Contact Us</h3>
							<div id="contact_form">
								...
								<form action="./controller.php" method ="post">
									<!-- Left Form Starts -->
									<div id="left_form" class = "col-xs-12 col-sm-6">
										<div class="form-group">
											<span><label for = "guest_name">NAME</label></span>
											<span><input name="guestName" type="text" class="textbox" id ="guest_name" placeholder="Johnny Hsu" required></span>
										</div>

										<div>
											<span><label for = "guest_email">EMAIL</label></span>
											<span><input name="guestEmail" type="email" class="textbox" id = "guest_email" placeholder="example@gmail.com" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"></span>
										</div>

										<div>
											<span><label for = "guest_phone">PHONE</label></span>
											<span><input name="guestPhone" type="tel" class="textbox" id = "guest_phone" placeholder="5550000001"></span>
										</div>
									</div>
									<!-- Left Form End -->
									...
									<div id="right_form" class = "col-xs-12 col-sm-6">
										<div>					    	
											<span><label for = "message">MESSAGE</label></span>
											<span>
												<textarea name="message" id = "message" placeholder = "Welcome to say something to me......" required> </textarea>
											</span>
										</div>
										<div class="text-right">
											<input name ="submitMessage" type="submit" class="btn btn-primary" value="Submit">
										</div>
									</div>
									<!-- Right Form End -->
								</form>
