...
<?php
	...
	if (isset ($_SESSION['username']) || (!empty($_COOKIE['username']) && isset($_COOKIE['username']) )){
		...
		if (isset($_SESSION['moviesToDownload'])){
			...
			echo "<li><a href=''><span class='glyphicon glyphicon-shopping-cart'></span><span class='badge'>". 0 . "</span>";
			echo " Checkout <i class='fa fa-angle-right'></i></a></li>";
		}
		echo '				
					</ul>
...
<main>
		...
		<section>
			<div class = "container-fluid">	
				<div class = "row">
					<h1 class = "center-block text-center ">Got Your Message</h1>
				</div>
				
				<div class="row">
					<img src="image/thank_you.jpg" class="img-responsive center-block" alt="Thank you">	
				</div>

				<div class = "row">
					<p id="message" class = "text-center">
						Thank you for leaving us message
					</p>
				</div>

				<div class="row">
					<div  class="btn btn-primary btn-lg text-center col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-4 col-md-4 col-md-offset-4 col-lg-2 col-lg-offset-5">
						<a href="index.php" class="text-white text-hover-white">Go to Homepage</a>
					</div>
				</div>
			</div>
		</section>
